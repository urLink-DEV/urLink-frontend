...
import { useLinks, selectSelectedLink, linksReadThunk, linkModifyThunk } from '@modules/link'
...
function LinkList() {
  ...
  console.log(links, selectedCategory?.id)
      ...
      <main className={classes.content}>
        ...
        <div container>
          {links.length ? (
            ...
            <img className={classes.imgCenter} src={CategoryEmptyIcon} alt="category list empty" />
          ) : searchValue ? (
            <img
            ...
            <img className={classes.imgCenter} src={linkListEmptyIcon} alt="link list empty" />
          )}
        </div>
      </main>
    </>
