    ...
    >
      ...
      <DialogContent>
        <DialogContentText id="alert-dialog-description">
          &lt;유어링크&gt;('urLink'이하 'urLink')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호
          및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은
          처리방침을 두고 있습니다.
          <br />
          &lt;유어링크&gt;('urLink') 은(는) 회사는 개인정보처리방침을 개정하는 경우 웹사이트
          공지사항(또는 개별공지)을 통하여 공지할 것입니다.
          <br />
          ○ 본 방침은부터 2020년 6월 27일부터 시행됩니다.
          <br />
          1. 개인정보의 처리 목적 &lt;유어링크&gt;('urLink'이하 'urLink')은(는) 개인정보를 다음의
          ...
          - 수집방법 : 홈페이지
          <br />
          - 보유근거 : 사용자에게 url 보관 및 정리 서비스를 제공하기 위해 필수로 수집해야만 하는
          항목
          <br />
          - 보유기간 : 사용자 요구가 있을 때 지체없이 파기
          <br />
          <br />
          <br />
          <br />
          ...
          <br />
          <br />
          ① &lt;유어링크&gt;('urLink')은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
          ...
          동의일로부터&lt;회원 탈퇴 시 파기&gt;까지 위 이용목적을 위하여 보유.이용됩니다.
          <br />
          ...
          2.&lt;재화 또는 서비스 제공&gt;
          <br />
          &lt;재화 또는 서비스 제공&gt;와 관련한 개인정보는 수집.이용에 관한 동의일로부터 사용자의
          요구가 있거나 회원 탈퇴 시 파기 까지 위 이용목적을 위하여 보유.이용됩니다.
          <br />
          -보유근거 : 사용자에게 url 보관 및 정리 서비스를 제공하기 위해 필수로 수집해야만 하는 항목
          <br />
          <br />
          ...
          권리를 행사할 수 있습니다.
          <br />
          ① 정보주체는 유어링크에 대해 언제든지 개인정보 열람,정정,삭제,처리정지 요구 등의 권리를
          행사할 수 있습니다.
          <br />
          ② 제1항에 따른 권리 행사는유어링크에 대해 개인정보 보호법 시행령 제41조제1항에 따라
          전자우편을 통하여 하실 수 있으며 유어링크은(는) 이에 대해 지체 없이 조치하겠습니다.
          <br />
          ...
          <br />
          ⑥ 유어링크은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시
          ...
          <br />
          <br />
          ① &lt;유어링크&gt;('urLink'이하 'urLink')은(는) 다음의 개인정보 항목을 처리하고 있습니다.
          <br />
          1 &lt;재화 또는 서비스 제공&gt; - 필수항목 : 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP
          정보
          <br />
          <br />
          <br />
          <br />
          6. 개인정보의 파기&lt;유어링크&gt;('urLink')은(는) 원칙적으로 개인정보 처리목적이 달성된
          ...
          <br />
          ① 유어링크 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는
          ‘쿠키(cookie)’를 사용합니다.
          <br />
          ...
          통해 쿠키 저장을 거부 할 수 있습니다. 다. 쿠키 저장을 거부할 경우 맞춤형 서비스 이용에
          어려움이 발생할 수 있습니다.
          <br />
          <br />
          <br />
          ...
          <br />
          <br />
          ① 유어링크(‘urLink’이하 ‘urLink) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
          ...
          연락처 : gunwoo.yapp@gmail.com
          <br />
          ② 정보주체께서는 유어링크(‘urLink’이하 ‘urLink) 의 서비스(또는 사업)을 이용하시면서 발생한
          모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및
          담당부서로 문의하실 수 있습니다. 유어링크(‘urLink’이하 ‘urLink) 은(는) 정보주체의 문의에
          ...
          <br />
          <br />
          10. 개인정보의 안전성 확보 조치 &lt;유어링크&gt;('urLink')은(는) 개인정보보호법 제29조에
          따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.
          <br />
          ...
          3. 해킹 등에 대비한 기술적 대책
          <br />
          &lt;유어링크&gt;('urLink')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을
      ...
      <DialogActions>
        ...
        <Button onClick={onNoClick || onClose} color="primary" style={{ fontWeight: 'bold' }}>
          동의안함
        </Button>
      </DialogActions>
    </Dialog>
